...
export function HeroMobileMockup() {
  ...
  return (
    <div className="relative max-w-[360px] sm:max-w-[380px] w-full mx-auto pt-2">
      {/* Hardware Buttons (iPhone Side Volume & Power Buttons) */}
      <div className="absolute -left-1.5 top-32 w-1.5 h-9 bg-slate-300 dark:bg-slate-700 rounded-l-md shadow-xs" />
      <div className="absolute -left-1.5 top-44 w-1.5 h-9 bg-slate-300 dark:bg-slate-700 rounded-l-md shadow-xs" />
      <div className="absolute -right-1.5 top-36 w-1.5 h-14 bg-slate-300 dark:bg-slate-700 rounded-r-md shadow-xs" />

      {/* iPhone Outer Body Chassis - Elongated Pro Aspect Ratio */}
      <div className="bg-white dark:bg-[#0d121f] p-3.5 sm:p-4 rounded-t-[56px] rounded-b-[48px] shadow-[0_30px_70px_-15px_rgba(0,0,0,0.28)] ring-1 ring-slate-200/90 dark:ring-slate-800 border border-slate-200/80 dark:border-slate-800 transition-all duration-300 flex flex-col justify-between min-h-[610px] sm:min-h-[650px]">
        
        <div>
          {/* iPhone Dynamic Island Notch */}
          <div className="w-28 h-5 bg-black rounded-full mx-auto mt-0.5 mb-4 flex items-center justify-center gap-2 border border-slate-900 shadow-inner">
          ...
          <div className="bg-white text-slate-900 rounded-[38px] p-6 shadow-inner flex flex-col space-y-6 font-sans border border-slate-100 min-h-[550px] sm:min-h-[590px] justify-between">
            ...
            {/* Bottom Actions & iPhone Home Indicator */}
            <div className="space-y-4 pt-2">
              {/* Primary Action Button (Solid iPhone Dark Button) */}
              <Link
                href="/quotes"
                className="w-full py-3.5 px-4 bg-[#18181b] hover:bg-[#27272a] text-white font-semibold text-xs rounded-2xl shadow-md transition-all duration-150 flex items-center justify-center gap-2 cursor-pointer font-sans active:scale-[0.99] text-center"
              >
                <span>Next: Specify your wallet</span>
              </Link>

              {/* Footer Branding */}
              <div className="text-center text-[11px] text-slate-400 flex items-center justify-center gap-1 font-sans">
              ...
              {/* iPhone Home Swipe Indicator Bar */}
              <div className="w-32 h-1 bg-slate-300 rounded-full mx-auto pt-0.5" />
            </div>
