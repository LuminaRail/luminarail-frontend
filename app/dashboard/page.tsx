...
function DashboardContent() {
      ...
      <div className="relative min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 flex flex-col overflow-x-hidden transition-colors duration-200">
        ...
        <div className="relative z-10 flex flex-col flex-1">
          ...
          <main className="max-w-xl mx-auto py-20 px-4 text-center">
            <div className="bg-white/90 dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 rounded-3xl p-10 shadow-2xl backdrop-blur-md">
              <div className="w-14 h-14 rounded-2xl bg-indigo-500/10 border border-indigo-500/20 text-indigo-600 dark:text-indigo-400 flex items-center justify-center mx-auto mb-5">
                <Lock className="w-7 h-7" />
              </div>
              <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-100">Sign in to Access Dashboard</h1>
              <p className="text-sm text-slate-600 dark:text-slate-400 mt-2 mb-8">
                Please sign in to view your LuminaRail NGN deposit analytics, live quotes, and Stellar USDC settlement history.
              </p>
              <Link
                href="/auth/login"
                className="inline-flex items-center justify-center w-full py-3.5 px-6 bg-emerald-600 hover:bg-emerald-500 text-white rounded-xl font-bold text-sm shadow-lg transition-all cursor-pointer font-sans"
              >
                Sign In to Account
              </Link>
            </div>
  ...
  return (
    <div className="relative min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 flex flex-col overflow-x-hidden font-sans transition-colors duration-200">
      ...
      <div className="relative z-10 flex flex-col flex-1">
        ...
        <main className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8 flex-1 w-full space-y-8">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 bg-white/80 dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800/80 rounded-2xl p-6 shadow-xl backdrop-blur-md">
            <div>
              <div className="flex items-center gap-3">
                <h1 className="text-2xl sm:text-3xl font-extrabold text-slate-900 dark:text-white tracking-tight">
                  Welcome back, <span className="text-emerald-600 dark:text-emerald-400">{user?.email.split('@')[0]}</span>
                </h1>
                <span className="text-xs font-mono uppercase tracking-widest text-emerald-700 dark:text-emerald-400 px-2.5 py-0.5 rounded-full bg-emerald-50 dark:bg-emerald-950/80 border border-emerald-200 dark:border-emerald-800/80">
                  ACTIVE DEPOSIT RAIL
                </span>
              </div>
            ...
            <div className="flex items-center gap-3 shrink-0">
              <button
                ...
                className="p-3 rounded-xl bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white hover:border-slate-300 dark:hover:border-slate-700 transition-all cursor-pointer shadow-xs"
              ...
              <button
                ...
                className="py-3 px-5 bg-gradient-to-r from-emerald-600 to-teal-500 hover:from-emerald-500 hover:to-teal-400 text-white font-bold text-xs rounded-xl shadow-lg transition-all flex items-center gap-2 cursor-pointer font-sans"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            <div className="bg-white/90 dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 shadow-lg backdrop-blur-md flex flex-col justify-between">
              <div className="flex items-center justify-between">
                <span className="text-[11px] font-mono font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Total NGN Deposited</span>
              ...
              <div className="mt-4">
                ...
                <div className="text-[11px] text-slate-500 mt-1 flex items-center gap-1">
                  <span className="text-emerald-600 dark:text-emerald-400 font-semibold">100% Guaranteed</span> via Paystack Rail
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/90 dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 shadow-lg backdrop-blur-md flex flex-col justify-between">
              <div className="flex items-center justify-between">
                <span className="text-[11px] font-mono font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Total USDC Settled</span>
              ...
              <div className="mt-4">
                <div className="text-2xl font-bold text-sky-600 dark:text-sky-400">
                  {(stats?.completedVolumeUsdc ?? 0).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })} <span className="text-xs font-normal text-sky-700 dark:text-sky-300">USDC</span>
                </div>
            ...
            <div className="bg-white/90 dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 shadow-lg backdrop-blur-md flex flex-col justify-between">
              <div className="flex items-center justify-between">
                <span className="text-[11px] font-mono font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Active Orders</span>
              ...
              <div className="mt-4">
                <div className="text-2xl font-bold text-amber-600 dark:text-amber-300">
                  {(stats?.pendingCount ?? 0) + (stats?.processingCount ?? 0)} <span className="text-xs font-normal text-slate-500 dark:text-slate-400">orders</span>
                </div>
                <div className="text-[11px] text-slate-500 mt-1">
            ...
            <div className="bg-white/90 dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 shadow-lg backdrop-blur-md flex flex-col justify-between">
              <div className="flex items-center justify-between">
                <span className="text-[11px] font-mono font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Stellar Wallet</span>
              ...
              <div className="mt-4">
                {connectedWallet ? (
                  <div>
                    <div className="text-sm font-mono font-bold text-emerald-600 dark:text-emerald-400 truncate">
                      {connectedWallet.slice(0, 10)}...{connectedWallet.slice(-6)}
                    </div>
                    <div className="text-[11px] text-emerald-600 dark:text-emerald-400/80 mt-1 flex items-center gap-1 font-medium">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 shadow-xl backdrop-blur-md flex flex-col justify-between">
              <div>
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-2">
                    ...
                    <h2 className="text-base font-bold text-slate-900 dark:text-white">Instant NGN → USDC On-Ramp</h2>
                  </div>
                  <span className="text-[10px] font-mono uppercase px-2 py-0.5 rounded bg-emerald-50 dark:bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-500/20">
                    REAL FX RATES
                  </span>
                </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="flex overflow-hidden rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-100 dark:bg-slate-950 shadow-inner">
                      <div className="flex items-center gap-2 border-r border-slate-200 dark:border-slate-700 px-4 font-bold text-sm bg-slate-200/60 dark:bg-slate-900/60 text-slate-800 dark:text-slate-200">
                      ...
                      <input
                        ...
                        placeholder="100000"
                        className="min-w-0 flex-1 bg-transparent px-4 py-3.5 text-xl font-bold text-slate-900 dark:text-white outline-none font-mono"
                      />
                    </div>
                  </div>
                      ...
                      <button
                        ...
                        className={`px-3 py-1.5 rounded-lg text-xs font-mono font-semibold transition-all cursor-pointer ${
                          depositAmount === preset
                            ...
                            : 'bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-200 hover:bg-slate-200 dark:hover:bg-slate-800'
                        }`}
                      >
                  ...
                  {quoteLoading ? (
                    <div className="p-4 rounded-xl bg-slate-100 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 flex items-center justify-center gap-2 text-slate-500 dark:text-slate-400 text-xs">
                    ...
                    <div className="p-4 rounded-xl bg-slate-100 dark:bg-slate-950 border border-emerald-500/30 space-y-3">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <div className="text-2xl font-black text-emerald-600 dark:text-emerald-400 mt-0.5">
                            ...
                            <span className="text-sm font-semibold text-emerald-700 dark:text-emerald-300">USDC</span>
                          </div>
                        </div>
                      ...
                      <div className="pt-2 border-t border-slate-200 dark:border-slate-800/80 flex items-center justify-between text-[11px] text-slate-500 dark:text-slate-400">
                        <span>Platform Fee: <strong className="text-slate-800 dark:text-slate-200">₦{Number(currentQuote.fee).toLocaleString()} NGN</strong></span>
                        <span>Provider: <strong className="text-indigo-600 dark:text-indigo-300 font-mono">PAYSTACK REAL FX</strong></span>
                        <span>Quote Locks: <strong className="text-amber-600 dark:text-amber-400 font-mono">{new Date(currentQuote.expiresAt).toLocaleTimeString()}</strong></span>
                      </div>
                    </div>
                  ) : quoteError ? (
              ...
              <div className="pt-4">
                <button
                  ...
                  className="w-full py-3.5 px-4 bg-emerald-600 hover:bg-emerald-500 disabled:opacity-50 text-white font-extrabold text-sm rounded-xl shadow-xl transition-all flex items-center justify-center gap-2 cursor-pointer font-sans"
                >
            ...
            <div className="bg-white/90 dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 shadow-xl backdrop-blur-md flex flex-col justify-between space-y-4">
              <div>
                ...
                <ol className="space-y-4 text-xs">
                  <li className="flex items-start gap-3">
                    <span className="w-5 h-5 rounded-full bg-emerald-500/20 text-emerald-600 dark:text-emerald-400 font-mono font-bold flex items-center justify-center text-[10px] shrink-0 mt-0.5">
                      1
                    </span>
                    <div>
                      <span className="font-semibold text-slate-900 dark:text-slate-100">Lock Real FX Rate</span>
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <span className="font-semibold text-slate-900 dark:text-slate-100">Pay via Paystack Checkout</span>
                      <p className="text-slate-600 dark:text-slate-400 text-[11px] mt-0.5">
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <span className="font-semibold text-slate-900 dark:text-slate-100">Automatic Soroban Settlement</span>
                      <p className="text-slate-600 dark:text-slate-400 text-[11px] mt-0.5">
              ...
              <div className="p-3.5 rounded-xl bg-slate-100 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 text-[11px] text-slate-600 dark:text-slate-400">
                <span className="font-semibold text-emerald-600 dark:text-emerald-400 block mb-0.5">Stellar Testnet Horizon</span>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-lg font-bold text-slate-900 dark:text-white">Recent NGN Deposit & Settlement Orders</h2>
                <p className="text-xs text-slate-600 dark:text-slate-400">Audit trail of all your on-ramp requests and Stellar transactions.</p>
              </div>
              <Link
                href="/orders"
            ...
            {ordersLoading && orders.length === 0 ? (
              <div className="bg-white/60 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800 rounded-2xl p-12 text-center flex flex-col items-center justify-center gap-3">
                ...
                <p className="text-sm font-semibold text-slate-800 dark:text-slate-300">Loading your deposit orders...</p>
              </div>
            ) : orders.length === 0 ? (
              <div className="bg-white/60 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800 rounded-2xl p-12 text-center flex flex-col items-center justify-center gap-3">
                ...
                <p className="text-sm font-bold text-slate-800 dark:text-slate-200">No NGN deposits recorded yet</p>
                        ...
                        return (
                          ...
                          >
                            ...
                            <td className="py-4 px-4 font-bold text-slate-900 dark:text-slate-100">
                              ...
                              <span className="text-slate-500 dark:text-slate-400 font-normal text-[11px]">NGN</span>
                            </td>
                            <td className="py-4 px-4 font-bold text-emerald-600 dark:text-emerald-400">
                              {Number(ord.destinationAmount).toLocaleString()}{' '}
                              <span className="text-emerald-700 dark:text-emerald-300 font-normal text-[11px]">{ord.destinationAsset}</span>
                            </td>
                            ...
                            <td className="py-4 px-4 font-mono">
                              {txHash ? (
                                ...
                                <span className="text-slate-400 dark:text-slate-500 text-[11px]">Pending Settlement</span>
                              )}
                            </td>
                            ...
                            <td className="py-4 px-4 text-right" onClick={(e) => e.stopPropagation()}>
                              <div className="flex items-center justify-end gap-2">
                                ...
                                <button
                                  onClick={() => handleOpenDetails(ord.id)}
                                  className="py-1.5 px-3 bg-slate-100 dark:bg-slate-800 hover:bg-emerald-50 dark:hover:bg-emerald-600/20 text-slate-700 dark:text-slate-300 rounded-lg text-xs font-semibold transition-all border border-slate-200 dark:border-slate-700 hover:border-emerald-500/40 cursor-pointer font-sans"
                                >
                                  Details
                                </button>
                              </div>
